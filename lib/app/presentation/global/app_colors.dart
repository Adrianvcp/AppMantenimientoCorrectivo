...
class AppColors {
  ...
  static const Color placeholder = Color.fromARGB(255, 7, 7, 7);
  ...
  static const Color kBottomColor = Color(0xFF044454);

  static const Color kColorPrimary =  Color(0xfffbbb21);
